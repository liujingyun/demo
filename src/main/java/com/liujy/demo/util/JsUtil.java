...
public class JsUtil {
     ...
     * @author liujingyun
     */
    public void setNewJs(String... jsFilePaths) throws FileNotFoundException, ScriptException {
     ...
     * @author liujingyun
     */
    public void setNewJs(URL... jsUrls) throws ScriptException, IOException {
        ScriptEngineManager mgr = new ScriptEngineManager();
        ScriptEngine engine = mgr.getEngineByMimeType("text/javascript");
        //从网络读取js文件流
        for (URL url : jsUrls) {
